package com.example.calinisan_multipurposecalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previousCalculation = findViewById(R.id.previousCalculatorView);
    ...
    public void updateText(String strToAdd){
        ...
        display.setText(String.format("%s%s%s", oldStr, strToAdd, rightStr));
    ...
    public void naturalLogTextBTNPush(View view){
        updateText("ln(");
    }
    public void LogTextBTNPush(View view){
        updateText("log(");
    }
    public void squareRootTextBTNPush(View view){
        updateText("sqrt(");
    }
    public void absoluteValueTextBTNPush(View view){
        updateText("abs(");
    }
    ...
    public void xSquareTextBTNPush(View view){
        updateText("^(2)");
    }
